...
void reply_music(int fd)
{
	...
	json_object_array_add(arr, json_object_new_string("其他/1.mp3"));
	json_object_array_add(arr, json_object_new_string("其他/2.mp3"));
	json_object_array_add(arr, json_object_new_string("其他/3.mp3"));
	json_object_array_add(arr, json_object_new_string("其他/4.mp3"));
	json_object_array_add(arr, json_object_new_string("其他/5.mp3"));
