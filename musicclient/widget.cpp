    ...
    ui(new Ui::Widget)
{
    ...
    socket->connectToHost(QHostAddress("47.111.108.71"), 8000);
...
void Widget::on_registerButton_clicked()
{
    ...
    //发送给服务器{"cmd":"app_register", "appid":"1001", "password":"0001"}
    QJsonObject obj;
...
void Widget::app_login_handler(QJsonObject &obj)
{
    ...
    if (result == "not_exist")
    {
        QMessageBox::warning(this, "登陆提示", "用户不存在，请先注册");
    }
    else if(result == "password_error")
    {
        QMessageBox::warning(this, "登陆提示", "密码错误，请检查用户名或密码");
    }
    else if(result == "not_bind")
    {
        QMessageBox::information(this, "登陆提示", "登陆成功，未绑定设备");
    ...
    {
        QMessageBox::information(this, "登陆提示", "登录成功，已绑定设备");
...
void Widget::on_loginButton_clicked()
{
    ...
    this->m_appid = appid;
    //发送给服务器{"cmd":"app_login", "appid":"", "password":""}
    QJsonObject obj;
